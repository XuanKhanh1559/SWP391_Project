    ...
    <div class="nav-container">
        ...
        <ul class="nav-menu" id="navMenu">
            ...
            <li id="userMenu" style="display: none;">
                ...
                <a href="${pageContext.request.contextPath}/user/orders" class="nav-link" data-page="orders">Đơn hàng</a>
                <a href="${pageContext.request.contextPath}/user/coupons" class="nav-link" data-page="coupons">Mã giảm giá</a>
