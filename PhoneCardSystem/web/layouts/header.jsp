...
<%
    ...
    // session is an implicit JSP object, no need to declare it
...
<nav class="navbar">
    <div class="nav-container">
        ...
        <ul class="nav-menu" id="navMenu">
            ...
            <li id="userMenu" class="nav-item-group">
            ...
            <% } %>
            <% if (isLoggedIn && isAdmin) { %>
            <li id="adminMenu" class="nav-item">
        ...
        <div class="nav-actions">
            ...
            <div class="nav-user" id="navUser">
                <a href="#" class="nav-link" id="userMenuToggle"><i class="fas fa-user"></i> <span id="userName"><%= user != null ? user.getUsername() : "Tài khoản" %></span></a>
                <div class="user-dropdown" id="userDropdown">
                    <a href="${pageContext.request.contextPath}/profile">Hồ sơ</a>
                    <a href="${pageContext.request.contextPath}/user/deposit.jsp">Nạp tiền</a>
                    <a href="${pageContext.request.contextPath}/logout" id="logoutBtn">Đăng xuất</a>
